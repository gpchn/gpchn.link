...
![域名管理](白嫖服务器-link-顶级域名/4.png)

刚刚注册的链接会显示在这，点进去：

![点进域名](白嫖服务器-link-顶级域名/5.png)

往下划，找到 DNS Settings：

![DNS-Settings](白嫖服务器-link-顶级域名/6.png)

点进去，在展开的选项中选第一个 Name Servers：

![Name-Servers](白嫖服务器-link-顶级域名/7.png)
...
![DNS记录](白嫖服务器-link-顶级域名/9.png)

这是我已经设置好的样子，你的应该是空的，点击图中右上方的添加记录按钮，你需要添加两个，一个需要在左侧的选项中选则“A”，一个是“CNAME”：

![A](白嫖服务器-link-顶级域名/10.png)
![CNAME](白嫖服务器-link-顶级域名/11.png)
...
![vercel](白嫖服务器-link-顶级域名/12.png)

然后选中刚刚创建的 GitHub 仓库，点击 import：

![GitHub-repo](白嫖服务器-link-顶级域名/13.png)

按照提示完成项目的创建，进入到项目页面，点击上方横向菜单最后一个 Settings，然后点击左侧竖向菜单的 Domains：

![Settings-Domains](白嫖服务器-link-顶级域名/14.png)

在输入框中输入新注册的域名，点击 Add：

![Add](白嫖服务器-link-顶级域名/15.png)

三个选项自己选择，如果不懂就选第一个。选好以后会跳出来两个配置未确认页面：

![config-A](白嫖服务器-link-顶级域名/16.png)
![config-CNAME](白嫖服务器-link-顶级域名/17.png)
